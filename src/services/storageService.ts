...
const DEFAULT_PRODUCTS: Product[] = [
    ...
    { id: 'b1c2d3e4-f5g6-h7i8-j9k0-l1m2n3o4p5q6', name: 'บล็อคลอย G-Power 4x4', color: 'สีขาว', salePrice: 5.08 },
    { id: 'c2d3e4f5-g6h7-i8j9-k0l1-m2n3o4p5q6r7', name: 'บล็อคลอย G-Power 2x4B', color: 'สีขาว', salePrice: 3.7 },
    { id: 'd3e4f5g6-h7i8-j9k0-l1m2-n3o4p5q6r7s8', name: 'บล็อคลอย G-Power 4x4B', color: 'สีขาว', salePrice: 5.2 },
    { id: 'e4f5g6h7-i8j9-k0l1-m2n3-o4p5q6r7s8t9', name: 'บล็อคลอย CT 2x4', color: 'สีขาว', salePrice: 3.83 },
    { id: 'f5g6h7i8-j9k0-l1m2-n3o4-p5q6r7s8t9u0', name: 'บล็อคลอย CT 4x4', color: 'สีขาว', salePrice: 5.08 },
    { id: 'g6h7i8j9-k0l1-m2n3-o4p5-q6r7s8t9u0v1', name: 'บล็อคลอย CT 2x4B', color: 'สีขาว', salePrice: 3.7 },
    { id: 'h7i8j9k0-l1m2-n3o4-p5q6-r7s8t9u0v1w2', name: 'บล็อคลอย CT 4x4B', color: 'สีขาว', salePrice: 5.2 },
    { id: 'i8j9k0l1-m2n3-o4p5-q6r7-s8t9u0v1w2x3', name: 'ฝาหน้ากาก CT A-101', color: 'สีขาว', salePrice: 3.77 },
    { id: 'j9k0l1m2-n3o4-p5q6-r7s8-t9u0v1w2x3y4', name: 'ฝาหน้ากาก CT A-101B', color: 'สีขาว', salePrice: 0 },
    { id: 'k0l1m2n3-o4p5-q6r7-s8t9-u0v1w2x3y4z5', name: 'ฝาหน้ากาก CT A-102', color: 'สีขาว', salePrice: 3.7 },
    { id: 'l1m2n3o4-p5q6-r7s8-t9u0-v1w2x3y4z5a6', name: 'ฝาหน้ากาก CT A-102B', color: 'สีขาว', salePrice: 3.7 },
    { id: 'm2n3o4p5-q6r7-s8t9-u0v1-w2x3y4z5a6b7', name: 'ฝาหน้ากาก CT A-103', color: 'สีขาว', salePrice: 3.57 },
    { id: 'n3o4p5q6-r7s8-t9u0-v1w2-x3y4z5a6b7c8', name: 'ฝาหน้ากาก CT A-103B', color: 'สีขาว', salePrice: 3.35 },
    { id: 'o4p5q6r7-s8t9-u0v1-w2x3-y4z5a6b7c8d9', name: 'ฝาหน้ากาก CT A-1022', color: 'สีขาว', salePrice: 3.92 },
    { id: 'p5q6r7s8-t9u0-v1w2-x3y4-z5a6b7c8d9e0', name: 'ฝาหน้ากาก CT A-1022B', color: 'สีขาว', salePrice: 3.66 },
    { id: 'q6r7s8t9-u0v1-w2x3-y4z5-a6b7c8d9e0f1', name: 'ฝาหน้ากาก CT A-104', color: 'สีขาว', salePrice: 4.92 },
    { id: 'r7s8t9u0-v1w2-x3y4-z5a6-b7c8d9e0f1g2', name: 'ฝาหน้ากาก CT A-106', color: 'สีขาว', salePrice: 5.02 },
    { id: 's8t9u0v1-w2x3-y4z5-a6b7-c8d9e0f1g2h3', name: 'ฝาหน้ากาก CT A-104B', color: 'สีขาว', salePrice: 0 },
    { id: 't9u0v1w2-x3y4-z5a6-b7c8-d9e0f1g2h3i4', name: 'ฝาหน้ากาก CT A-106B', color: 'สีขาว', salePrice: 0 },
    { id: 'u0v1w2x3-y4z5-a6b7-c8d9-e0f1g2h3i4j5', name: 'บล็อคลอย BEWON 2x4', color: 'สีขาว', salePrice: 3.83 },
    { id: 'v1w2x3y4-z5a6-b7c8-d9e0-f1g2h3i4j5k6', name: 'บล็อคลอย BEWON 4x4', color: 'สีขาว', salePrice: 5.32 },
    { id: 'w2x3y4z5-a6b7-c8d9-e0f1-g2h3i4j5k6l7', name: 'ฝาหน้ากาก BEWON 201', color: 'สีขาว', salePrice: 3.68 },
    { id: 'x3y4z5a6-b7c8-d9e0-f1g2-h3i4j5k6l7m8', name: 'ฝาหน้ากาก BEWON 202', color: 'สีขาว', salePrice: 3.6 },
    { id: 'y4z5a6b7-c8d9-e0f1-g2h3-i4j5k6l7m8n9', name: 'ฝาหน้ากาก BEWON 203', color: 'สีขาว', salePrice: 3.57 },
    { id: 'z5a6b7c8-d9e0-f1g2-h3i4-j5k6l7m8n9o0', name: 'ฝาหน้ากาก BEWON 222', color: 'สีขาว', salePrice: 3.84 },
    { id: 'a6b7c8d9-e0f1-g2h3-i4j5-k6l7m8n9o0p1', name: 'ฝาหน้ากาก BEWON 604', color: 'สีขาว', salePrice: 5.29 },
    { id: 'b7c8d9e0-f1g2-h3i4-j5k6-l7m8n9o0p1q2', name: 'ฝาหน้ากาก BEWON 606', color: 'สีขาว', salePrice: 5.22 },
    { id: 'c8d9e0f1-g2h3-i4j5-k6l7-m8n9o0p1q2r3', name: 'ฝา CHONG-2 PC', color: 'เทาใส', salePrice: 4.01 },
    { id: 'd9e0f1g2-h3i4-j5k6-l7m8-n9o0p1q2r3s4', name: 'ฝา CHONG-4 PC', color: 'เทาใส', salePrice: 6.73 },
    { id: 'e0f1g2h3-i4j5-k6l7-m8n9-o0p1q2r3s4t5', name: 'ฝา CHONG-6 PC', color: 'เทาใส', salePrice: 8.78 },
    { id: 'f1g2h3i4-j5k6-l7m8-n9o0-p1q2r3s4t5u6', name: 'ฝา CHONG-8 PC', color: 'เทาใส', salePrice: 10.58 },
    { id: 'g2h3i4j5-k6l7-m8n9-o0p1-q2r3s4t5u6v7', name: 'ฝา CHONG-10 PC', color: 'เทาใส', salePrice: 12.06 },
    { id: 'h3i4j5k6-l7m8-n9o0-p1q2-r3s4t5u6v7w8', name: 'ฝา CHONG-2 ABS', color: 'สีขาว', salePrice: 6.75 },
    { id: 'i4j5k6l7-m8n9-o0p1-q2r3-s4t5u6v7w8x9', name: 'ฝา CHONG-4 ABS', color: 'สีขาว', salePrice: 9.85 },
    { id: 'j5k6l7m8-n9o0-p1q2-r3s4-t5u6v7w8x9y0', name: 'ฝา CHONG-6 ABS', color: 'สีขาว', salePrice: 11.62 },
    { id: 'k6l7m8n9-o0p1-q2r3-s4t5-u6v7w8x9y0z1', name: 'ฝา CHONG-8 ABS', color: 'สีขาว', salePrice: 13.04 },
    { id: 'l7m8n9o0-p1q2-r3s4-t5u6-v7w8x9y0z1a2', name: 'ฝา CHONG-10 ABS', color: 'สีขาว', salePrice: 14.6 },
    { id: 'm8n9o0p1-q2r3-s4t5-u6v7-w8x9y0z1a2b3', name: 'CTU ฝา NEW 2 PC', color: 'ดำใส', salePrice: 4.74 },
    { id: 'n9o0p1q2-r3s4-t5u6-v7w8-x9y0z1a2b3c4', name: 'CTU ฝา NEW 4 PC', color: 'ดำใส', salePrice: 5.97 },
    { id: 'o0p1q2r3-s4t5-u6v7-w8x9-y0z1a2b3c4d5', name: 'CTU ฝา NEW 6 PC', color: 'ดำใส', salePrice: 6.54 },
    { id: 'p1q2r3s4-t5u6-v7w8-x9y0-z1a2b3c4d5e6', name: 'CTU ฝา NEW 8 PC', color: 'ดำใส', salePrice: 7.4 },
    { id: 'q2r3s4t5-u6v7-w8x9-y0z1-a2b3c4d5e6f7', name: 'CTU ฝา NEW 10 PC', color: 'ดำใส', salePrice: 10 },
    { id: 'r3s4t5u6-v7w8-x9y0-z1a2-b3c4d5e6f7g8', name: 'CTU ฝา NEW 2 PC', color: 'สีขาว', salePrice: 8.8 },
    { id: 's4t5u6v7-w8x9-y0z1-a2b3-c4d5e6f7g8h9', name: 'CTU ฝา NEW 4 PC', color: 'สีขาว', salePrice: 14.87 },
    { id: 't5u6v7w8-x9y0-z1a2-b3c4-d5e6f7g8h9i0', name: 'CTU ฝา NEW 6 PC', color: 'สีขาว', salePrice: 16.7 },
    { id: 'u6v7w8x9-y0z1-a2b3-c4d5-e6f7g8h9i0j1', name: 'CTU ฝา NEW 8 PC', color: 'สีขาว', salePrice: 17.96 },
    { id: 'v7w8x9y0-z1a2-b3c4-d5e6-f7g8h9i0j1k2', name: 'CTU ฝา NEW 10 PC', color: 'สีขาว', salePrice: 23.53 },
    { id: 'w8x9y0z1-a2b3-c4d5-e6f7-g8h9i0j1k2l3', name: 'อุปกร์ฝาใส่ตู้', color: 'สีขาว', salePrice: 0.44 },
    { id: 'x9y0z1a2-b3c4-d5e6-f7g8-h9i0j1k2l3m4', name: 'ฝา M 4', color: 'ใส', salePrice: 6.73 },
    { id: 'y0z1a2b3-c4d5-e6f7-g8h9-i0j1k2l3m4n5', name: 'ฝา M 6', color: 'ใส', salePrice: 7.88 },
    { id: 'z1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6', name: 'ฝา M 8', color: 'ใส', salePrice: 9.6 },
    { id: 'a2b3c4d5-e6f7-g8h9-i0j1-k2l3m4n5o6p7', name: 'ฝา M 10', color: 'ใส', salePrice: 10.58 },
    { id: 'b3c4d5e6-f7g8-h9i0-j1k2-l3m4n5o6p7q8', name: 'ฝา M 12', color: 'ใส', salePrice: 11.16 },
    { id: 'c4d5e6f7-g8h9-i0j1-k2l3-m4n5o6p7q8r9', name: 'ฝา M 4', color: 'เทาใส', salePrice: 12.74 },
    { id: 'd5e6f7g8-h9i0-j1k2-l3m4-n5o6p7q8r9s0', name: 'ฝา M 6', color: 'เทาใส', salePrice: 14.84 },
    { id: 'e6f7g8h9-i0j1-k2l3-m4n5-o6p7q8r9s0t1', name: 'ฝา M 8', color: 'เทาใส', salePrice: 17.97 },
    { id: 'f7g8h9i0-j1k2-l3m4-n5o6-p7q8r9s0t1u2', name: 'ฝา M 10', color: 'เทาใส', salePrice: 19.77 },
    { id: 'g8h9i0j1-k2l3-m4n5-o6p7-q8r9s0t1u2v3', name: 'ฝา M 12', color: 'เทาใส', salePrice: 20.82 },
    { id: 'h9i0j1k2-l3m4-n5o6-p7q8-r9s0t1u2v3w4', name: 'ชุดล็อคเลือนเลื่อนเปิด-ปิด K1', color: 'สีขาว', salePrice: 0.58 },
    { id: 'i0j1k2l3-m4n5-o6p7-q8r9-s0t1u2v3w4x5', name: 'ชุดฐานล็อคเลือนเลื่อนเปิด-ปิด K2', color: 'สีขาว', salePrice: 0.77 },
    { id: 'j1k2l3m4-n5o6-p7q8-r9s0-t1u2v3w4x5y6', name: 'ฐานรองเบเกอร์เมน R1', color: 'สีขาว', salePrice: 5.05 },
    { id: 'k2l3m4n5-o6p7-q8r9-s0t1-u2v3w4x5y6z7', name: 'ฝาบิดบัสบาร์เมน R1-1', color: 'สีขาว', salePrice: 0.92 },
    { id: 'l3m4n5o6-p7q8-r9s0-t1u2-v3w4x5y6z7a8', name: 'ฐานรองเบรคย่อย T1', color: 'สีขาว', salePrice: 1.97 },
    { id: 'm4n5o6p7-q8r9-s0t1-u2v3-w4x5y6z7a8b9', name: 'ฝาปิดบัสบาร์ 2 ช่อง T1-1', color: 'สีขาว', salePrice: 0.36 },
    { id: 'n5o6p7q8-r9s0-t1u2-v3w4-x5y6z7a8b9c0', name: 'ขาล็อคข้อพับเปิด-ปิดฝา S1', color: 'สีขาว', salePrice: 0.33 },
    { id: 'o6p7q8r9-s0t1-u2v3-w4x5-y6z7a8b9c0d1', name: 'ขาพับเปิด-ปิดฝา S2', color: 'สีขาว', salePrice: 0.35 },
    { id: 'p7q8r9s0-t1u2-v3w4-x5y6-z7a8b9c0d1e2', name: 'ฐานรองเบเกอร์ 4 ช่อง C1', color: 'สีขาว', salePrice: 3.65 },
    { id: 'q8r9s0t1-u2v3-w4x5-y6z7-a8b9c0d1e2f3', name: 'ฝาปิดบัสบาร์ C1-1', color: 'สีขาว', salePrice: 0.56 },
    { id: 'r9s0t1u2-v3w4-x5y6-z7a8-b9c0d1e2f3g4', name: 'ฐานรองขั้วต่อสาย J1', color: 'สีขาว', salePrice: 1.01 },
    { id: 's0t1u2v3-w4x5-y6z7-a8b9-c0d1e2f3g4h5', name: 'ฐานรองขั้วต่อสาย J2', color: 'สีขาว', salePrice: 1.63 },
    { id: 't1u2v3w4-x5y6-z7a8-b9c0-d1e2f3g4h5i6', name: 'CNT เบรคเกอร์', color: 'สีขาว', salePrice: 4.53 },
    { id: 'u2v3w4x5-y6z7-a8b9-c0d1-e2f3g4h5i6j7', name: 'CWS-111 ฝาครอบด้านหน้า', color: 'สีขาว', salePrice: 0.49 },
    { id: 'v3w4x5y6-z7a8-b9c0-d1e2-f3g4h5i6j7k8', name: 'CWS-111 ฝาครอบด้านหน้า', color: 'สีดำ', salePrice: 0 },
    { id: 'w4x5y6z7-a8b9-c0d1-e2f3-g4h5i6j7k8l9', name: 'CWS-111 ฝาครอบด้านหลัง', color: 'สีขาว', salePrice: 0.78 },
    { id: 'x5y6z7a8-b9c0-d1e2-f3g4-h5i6j7k8l9m0', name: 'CWS-111 ชุดขาล็อคฝาครอบ', color: 'สีขาว', salePrice: 0.3 },
    { id: 'y6z7a8b9-c0d1-e2f3-g4h5-i6j7k8l9m0n1', name: 'CWS-111 ชุดล็อคขาเสียบ 2 ต่อ', color: 'สีขาว', salePrice: 0.32 },
    { id: 'z7a8b9c0-d1e2-f3g4-h5i6-j7k8l9m0n1o2', name: 'CWS-111 รองฝาเปิด-ปิดด้านในใหญ่', color: 'สีขาว', salePrice: 0.3 },
    { id: 'a8b9c0d1-e2f3-g4h5-i6j7-k8l9m0n1o2p3', name: 'CWS-111 รองฝาเปิด-ปิดด้านในเล็ก', color: 'สีขาว', salePrice: 0.3 },
    { id: 'b9c0d1e2-f3g4-h5i6-j7k8-l9m0n1o2p3q4', name: 'CWS-121 ฝาครอบด้านหน้า', color: 'สีขาว', salePrice: 0.49 },
    { id: 'c0d1e2f3-g4h5-i6j7-k8l9-m0n1o2p3q4r5', name: 'CWS-121 ฝาครอบด้านหน้า', color: 'สีดำ', salePrice: 0 },
    { id: 'd1e2f3g4-h5i6-j7k8-l9m0-n1o2p3q4r5s6', name: 'CWS-121 ฝาครอบด้านหลัง', color: 'สีขาว', salePrice: 0.78 },
    { id: 'e2f3g4h5-i6j7-k8l9-m0n1-o2p3q4r5s6t7', name: 'CWS-121 ชุดขาล็อคฝาครอบ', color: 'สีขาว', salePrice: 0.3 },
    { id: 'f3g4h5i6-j7k8-l9m0-n1o2-p3q4r5s6t7u8', name: 'CWS-121 ชุดล็อคขาเสียบ 2 ต่อ', color: 'สีขาว', salePrice: 0.32 },
    { id: 'g4h5i6j7-k8l9-m0n1-o2p3-q4r5s6t7u8v9', name: 'CWS-121 รองฝาเปิด-ปิดด้านในใหญ่', color: 'สีขาว', salePrice: 0.3 },
    { id: 'h5i6j7k8-l9m0-n1o2-p3q4-r5s6t7u8v9w0', name: 'CWS-121 รองฝาเปิด-ปิดด้านในเล็ก', color: 'สีขาว', salePrice: 0.3 },
    { id: 'i6j7k8l9-m0n1-o2p3-q4r5-s6t7u8v9w0x1', name: 'CPS-113 ฝาครอบด้านหน้า', color: 'สีขาว', salePrice: 0.97 },
    { id: 'j7k8l9m0-n1o2-p3q4-r5s6-t7u8v9w0x1y2', name: 'CPS-113 ฝาครอบด้านหลัง', color: 'สีขาว', salePrice: 1.02 },
    { id: 'k8l9m0n1-o2p3-q4r5-s6t7-u8v9w0x1y2z3', name: 'CPS-113 ชุดขาล็อคฝาครอบ', color: 'สีขาว', salePrice: 0.48 },
    { id: 'l9m0n1o2-p3q4-r5s6-t7u8-v9w0x1y2z3a4', name: 'ชุดขาล็อคขาเสียบสาย L', color: 'สีขาว', salePrice: 0.3 },
    { id: 'm0n1o2p3-q4r5-s6t7-u8v9-w0x1y2z3a4b5', name: 'ชุดขาล็อคขาเสียบสาย N', color: 'สีขาว', salePrice: 0.3 },
    { id: 'n1o2p3q4-r5s6-t7u8-v9w0-x1y2z3a4b5c6', name: 'ชุดขาล็อคขาเสียบสาย G', color: 'สีขาว', salePrice: 0.29 },
    { id: 'o2p3q4r5-s6t7-u8v9-w0x1-y2z3a4b5c6d7', name: 'CPS-116 ฝาครอบด้านหน้า', color: 'สีขาว', salePrice: 1.48 },
    { id: 'p3q4r5s6-t7u8-v9w0-x1y2-z3a4b5c6d7e8', name: 'CPS-116 ฝาครอบด้านหลัง', color: 'สีขาว', salePrice: 1.54 },
    { id: 'q4r5s6t7-u8v9-w0x1-y2z3-a4b5c6d7e8f9', name: 'CPS-116 ชุดขาล็อคฝาครอบ', color: 'สีขาว', salePrice: 0.48 },
    { id: 'r5s6t7u8-v9w0-x1y2-z3a4-b5c6d7e8f9g0', name: 'CPS-112 ฝาครอบด้านหน้า', color: 'สีขาว', salePrice: 0.63 },
    { id: 's6t7u8v9-w0x1-y2z3-a4b5-c6d7e8f9g0h1', name: 'CPS-112 ฝาครอบด้านหลัง', color: 'สีขาว', salePrice: 0.78 },
    { id: 't7u8v9w0-x1y2-z3a4-b5c6-d7e8f9g0h1i2', name: 'CPS-112 ชุดขาล็อคฝาครอบ', color: 'สีขาว', salePrice: 0.38 },
    { id: 'u8v9w0x1-y2z3-a4b5-c6d7-e8f9g0h1i2j3', name: 'ชุดล็อคขาเสียบสาย', color: 'สีขาว', salePrice: 0.35 },
    { id: 'v9w0x1y2-z3a4-b5c6-d7e8-f9g0h1i2j3k4', name: 'รองครอบด้านใน', color: 'สีขาว', salePrice: 0.42 },
    { id: 'w0x1y2z3-a4b5-c6d7-e8f9-g0h1i2j3k4l5', name: 'บล็อคฝัง 2x4', color: 'สีดำ', salePrice: 0 },
    { id: 'x1y2z3a4-b5c6-d7e8-f9g0-h1i2j3k4l5m6', name: 'บล็อคฝัง 4x4', color: 'สีดำ', salePrice: 0 },
    { id: 'y2z3a4b5-c6d7-e8f9-g0h1-i2j3k4l5m6n7', name: 'บล็อคฝัง 2x4', color: 'สีส้ม', salePrice: 0 },
    { id: 'z3a4b5c6-d7e8-f9g0-h1i2-j3k4l5m6n7o8', name: 'บล็อคฝัง 4x4', color: 'สีส้ม', salePrice: 0 },
];
