                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow overflow-hidden">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex-grow overflow-y-auto border rounded-lg bg-gray-50 p-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {stagedMaterials.map(item => (
                                        <div key={item._tempId} className="grid grid-cols-[4fr,2fr,2fr,2fr,auto] gap-2 items-center bg-white p-2 rounded shadow-sm">
                                            ...
                                            <input type="number" value={item.costPerUnit || ''} onChange={e => handleItemChange(item._tempId, 'costPerUnit', Number(e.target.value))} className={commonInputStyle} />
                         ...
                         <button onClick={handleConfirm} disabled={stagedMaterials.length === 0} className="mt-4 inline-flex items-center justify-center gap-2 px-4 py-2 border border-transparent font-semibold rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 disabled:bg-gray-400">
